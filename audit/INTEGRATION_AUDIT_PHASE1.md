...
- [apps/frontend/lib/__audit__/api-integration-coverage.ts](apps/frontend/lib/__audit__/api-integration-coverage.ts) - Cobertura declarada
...
*Relatório gerado pelo Ouvify Auditor (ROMA Framework)*  
