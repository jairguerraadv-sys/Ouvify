...
**Context ([apps/backend/apps/core/utils/__init__.py](apps/backend/apps/core/utils/__init__.py)):**
```python
...
- [apps/backend/apps/core/utils/__init__.py](apps/backend/apps/core/utils/__init__.py) - get_current_tenant()
...
*Relatório gerado automaticamente pelo Ouvify Engineer*  
