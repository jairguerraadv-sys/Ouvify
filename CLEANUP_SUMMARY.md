...
**3. Diretórios __pycache__ (quantidade variável)**
```
__pycache__/ directories em apps/backend/
```
**Solução:** Remover todos os __pycache__
...
bash cleanup-final.sh
```
*Script interativo, pede confirmação para cada fase*
