...
class TestPrioridadeSystem:
    ...
    def test_create_feedback_with_default_prioridade(self, user_factory, tenant_factory):
    ...
    def test_create_feedback_with_critica_prioridade(self, user_factory, tenant_factory):
    ...
    def test_filter_by_prioridade(self, api_client, authenticated_user):
        ...
        try:
            ...
            all_feedbacks = list(Fb.objects.filter(client=tenant).values_list('prioridade', flat=True))
