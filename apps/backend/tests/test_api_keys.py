...
class TestAPIKeyGeneration:
    ...
    def test_generate_api_key(self, tenant):
        ...
        api_key, raw_key = APIKey.generate(
            client=tenant, name="Test Key", permissions="read"
        )
    ...
    def test_generate_api_key_with_expiration(self, tenant):
        ...
        api_key, raw_key = APIKey.generate(
            client=tenant, name="Expiring Key", expires_days=30
        )
    ...
    def test_generate_api_key_with_custom_rate_limit(self, tenant):
        ...
        api_key, raw_key = APIKey.generate(
            client=tenant, name="High Limit Key", rate_limit=5000
        )
...
class TestAPIKeyValidation:
    ...
    def test_validate_valid_key(self, tenant):
        ...
        api_key, raw_key = APIKey.generate(client=tenant, name="Valid Key")
    ...
    def test_validate_expired_key(self, tenant):
        ...
        api_key, raw_key = APIKey.generate(
            client=tenant, name="Expired Key", expires_days=1
        )
    ...
    def test_validate_revoked_key(self, tenant):
        ...
        api_key, raw_key = APIKey.generate(client=tenant, name="Revoked Key")
    ...
    def test_validate_updates_usage(self, tenant):
        ...
        api_key, raw_key = APIKey.generate(client=tenant, name="Usage Key")
...
class TestAPIKeyRateLimiting:
    ...
    def test_rate_limit_not_exceeded(self, tenant):
        ...
        api_key, raw_key = APIKey.generate(
            client=tenant, name="Limited Key", rate_limit=100
        )
    ...
    def test_rate_limit_exceeded(self, mock_cache, tenant):
        ...
        api_key, raw_key = APIKey.generate(
            client=tenant, name="Over Limit Key", rate_limit=10
        )
...
class TestAPIKeyPermissions:
    ...
    def test_read_permission(self, tenant):
        ...
        api_key, _ = APIKey.generate(client=tenant, name="Read Key", permissions="read")
    ...
    def test_write_permission(self, tenant):
        ...
        api_key, _ = APIKey.generate(
            client=tenant, name="Write Key", permissions="write"
        )
    ...
    def test_admin_permission(self, tenant):
        ...
        api_key, _ = APIKey.generate(
            client=tenant, name="Admin Key", permissions="admin"
        )
...
class TestAPIKeyRevocation:
    ...
    def test_revoke_key(self, tenant):
        ...
        api_key, raw_key = APIKey.generate(client=tenant, name="To Revoke")
    ...
    def test_revoked_key_string_representation(self, tenant):
        ...
        api_key, _ = APIKey.generate(client=tenant, name="String Key")
