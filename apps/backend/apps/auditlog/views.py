...
class AuditLogViewSet(viewsets.ReadOnlyModelViewSet):
    ...
    def analytics(self, request):
        ...
        total_users_active = queryset.exclude(
            user__isnull=True
        ...
        for item in severity_counts:
            severity_breakdown.append({
                ...
                'severity_display': severity_dict.get(item['severity'], item['severity']),
                'count': item['count'],
...
class AuditLogSummaryViewSet(viewsets.ReadOnlyModelViewSet):
    ...
    def get_queryset(self):
        ...
        return AuditLogSummary.objects.filter(
    ...
    def by_date(self, request):
        ...
        aggregated = (
            ...
            .annotate(
                ...
                total_actions=Count('action', distinct=True)
            )
            .order_by('date')
        )
