...
class PushSubscriptionAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Identificação", {"fields": ("user", "tenant", "active")}),
        (
            "Dados da Subscription",
            {"fields": ("endpoint", "p256dh", "auth"), "classes": ("collapse",)},
        ),
        (
            "Metadados",
            {"fields": ("user_agent", "ip_address"), "classes": ("collapse",)},
        ),
        (
            "Timestamps",
            {
...
class NotificationAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Destinatário", {"fields": ("tenant", "user")}),
        ("Conteúdo", {"fields": ("tipo", "title", "body", "icon", "url", "data")}),
        ("Status", {"fields": ("sent_at", "read_at", "clicked_at")}),
        (
            "Entrega",
            {
