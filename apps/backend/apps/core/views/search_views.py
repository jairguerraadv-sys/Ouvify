                            ...
                            'results': [
                                {
                                    ...
                                    'score': 12.5,
                                    'highlight': {
                                        'titulo': ['Feedback sobre <mark>atendimento</mark>']
                                    }
                                }
                            ],
                            'total': 42,
                ...
                'results': [
                    {
                        ...
                        'titulo': r.titulo,
                        'descricao': r.descricao[:200] + '...' if len(r.descricao) > 200 else r.descricao,
                        'tipo': r.tipo,
                        'status': r.status,
                        'score': r.score,
            ...
            200: {
                ...
                'content': {
                    'application/json': {
                        'example': {
                            'suggestions': [
                                {'id': '1', 'titulo': 'Feedback sobre atendimento', 'protocolo': 'OUVY-1234-5678'},
                                {'id': '2', 'titulo': 'Feedback sobre produto', 'protocolo': 'OUVY-2345-6789'}
                            ]
                        }
                    }
                }
