...
class Client(models.Model):
    ...
    plano = models.CharField(
        max_length=20, choices=PLANOS, default=FREE, verbose_name="Plano"
    )
    ...
    stripe_subscription_id = models.CharField(
        max_length=50, null=True, blank=True, verbose_name="Stripe Subscription ID"
    )

    subscription_status = models.CharField(
        max_length=20, default="active", verbose_name="Status da Assinatura"
    )

    data_fim_assinatura = models.DateTimeField(
        null=True, blank=True, verbose_name="Fim da Assinatura"
    )
    ...
    def is_premium(self) -> bool:
        ...
        return self.plano != self.FREE and self.subscription_status in {
            "active",
            "trialing",
        }
...
class TeamMember(models.Model):
    ...
    removed_at = models.DateTimeField(
        null=True, blank=True, verbose_name="Data de Remoção"
    )
...
class TeamInvitation(models.Model):
    ...
    expires_at = models.DateTimeField(
        verbose_name="Expira Em", help_text="Data de expiração do convite (7 dias)"
    )
