...
class TestUserRegistration:
    ...
    def test_register_with_duplicate_subdomain(self, api_client):
        ...
        Client.objects.create(nome="Existente", subdominio="existente", plano="free")
...
class TestJWTAuthentication:
    ...
    def test_obtain_token_with_invalid_credentials(self, api_client, tenant):
        ...
        url = reverse("token_obtain_pair")
        data = {"email": "naoexiste@example.com", "password": "SenhaErrada123!"}
...
class TestTenantIsolationAuth:
    ...
    def tenant1(self):
        return Client.objects.create(
            nome="Tenant 1", subdominio="tenant1", plano="professional", ativo=True
        )

    @pytest.fixture
    def tenant2(self):
        return Client.objects.create(
            nome="Tenant 2", subdominio="tenant2", plano="professional", ativo=True
        )
    ...
    def test_user_cannot_login_to_other_tenant(
        self, api_client, tenant1, tenant2, user1
    ):
        """Teste que usuário não consegue logar em outro tenant"""
        url = reverse("token_obtain_pair")
        data = {"email": "user1@tenant1.com", "password": "TestPass123!"}
