...
class TestTenantViewSet:
    ...
    def tenant(self):
        return Client.objects.create(
            nome="Test Tenant", subdominio="testtenant", plano="pro", ativo=True
        )
    ...
    def test_subdomain_format_validation(self, authenticated_admin):
        ...
        for subdomain in invalid_subdomains:
            data = {"nome": "Empresa", "subdominio": subdomain, "plano": "starter"}
    ...
    def test_update_tenant_branding(self, authenticated_owner, tenant):
        ...
        data = {"cor_primaria": "#FF5722", "cor_secundaria": "#2196F3"}
    ...
    def test_cannot_update_other_tenant(self, authenticated_owner, admin_user):
        ...
        other_tenant = Client.objects.create(
            nome="Outro Tenant", subdominio="outrotenant", plano="pro", ativo=True
        )
    ...
    def test_delete_tenant_as_superadmin(self, authenticated_admin):
        ...
        tenant_to_delete = Client.objects.create(
            nome="Para Deletar", subdominio="paradelete", plano="free", ativo=False
        )
...
class TestTenantModel:
    ...
    def test_str_representation(self):
        ...
        tenant = Client.objects.create(
            nome="Empresa Teste", subdominio="empresateste", plano="pro"
        )
    ...
    def test_default_plan(self):
        """Teste plano padrão"""
        tenant = Client.objects.create(nome="Nova Empresa", subdominio="novaempresa")
    ...
    def test_default_active_status(self):
        ...
        tenant = Client.objects.create(
            nome="Empresa Ativa", subdominio="empresaativa", plano="starter"
        )
...
class TestTenantServices:
    ...
    def tenant(self):
        return Client.objects.create(
            nome="Service Test", subdominio="servicetest", plano="pro", ativo=True
        )
    ...
    def test_tenant_has_plan_limits(self, tenant):
        ...
        assert (
            "max_feedbacks" in limits
            or "feedbacks_limit" in limits
    ...
    def test_subdomain_uniqueness(self, tenant):
        ...
        with pytest.raises(Exception):  # IntegrityError ou ValidationError
            Client.objects.create(
                nome="Duplicata", subdominio=tenant.subdominio, plano="free"
            )
