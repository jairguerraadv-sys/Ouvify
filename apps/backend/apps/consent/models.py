...
class UserConsent(models.Model):
    ...
    consent_version = models.ForeignKey(
        ConsentVersion, on_delete=models.PROTECT, related_name="user_consents"
    )
    ...
    context = models.CharField(
        max_length=50
    )  # 'signup', 'login', 'feedback', 'settings'
...
class ConsentLog(models.Model):
    ...
    user_consent = models.ForeignKey(
        UserConsent, on_delete=models.CASCADE, related_name="logs"
    )
