...
user_consent_detail = UserConsentViewSet.as_view({'get': 'retrieve', 'put': 'update', 'delete': 'destroy'})
...
urlpatterns = [
    ...
    path('versions/required/', consent_version_required, name='consent-versions-required'),
    ...
    path('user-consents/accept_anonymous/', user_consent_accept_anonymous, name='user-consents-accept-anonymous'),
    path('user-consents/<int:pk>/revoke/', user_consent_revoke, name='user-consents-revoke'),
