...
class Feedback(TenantAwareModel):
    ...
    titulo = models.CharField(
        max_length=200, verbose_name="Título", help_text="Título do feedback"
    )

    descricao = models.TextField(
        verbose_name="Descrição", help_text="Descrição detalhada do feedback"
    )
    ...
    assigned_at = models.DateTimeField(
        null=True, blank=True, verbose_name="Data de atribuição"
    )
    ...
    data_primeira_resposta = models.DateTimeField(
        null=True, blank=True, verbose_name="Data Primeira Resposta"
    )
    data_resolucao = models.DateTimeField(
        null=True, blank=True, verbose_name="Data de Resolução"
    )
    ...
    anonimo = models.BooleanField(
        default=False, verbose_name="Anônimo", help_text="Feedback enviado anonimamente"
    )
...
class FeedbackArquivo(TenantAwareModel):
    ...
    tamanho_bytes = models.PositiveIntegerField(
        verbose_name="Tamanho (bytes)", help_text="Tamanho do arquivo em bytes"
    )
