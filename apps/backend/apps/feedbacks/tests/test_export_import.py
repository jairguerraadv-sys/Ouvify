...
class ExportServiceTest(TestCase):
    ...
    def test_export_csv(self):
        ...
        response = ExportService.export_feedbacks(tenant=self.client_obj, format="csv")
    ...
    def test_export_json(self):
        ...
        response = ExportService.export_feedbacks(tenant=self.client_obj, format="json")
    ...
    def test_export_with_filters(self):
        ...
        response = ExportService.export_feedbacks(
            tenant=self.client_obj, format="json", filters={"tipo": "reclamacao"}
        )
    ...
    def test_export_invalid_format(self):
        ...
        with self.assertRaises(ValueError):
            ExportService.export_feedbacks(tenant=self.client_obj, format="pdf")
...
"""
        ...
        result = ImportService.import_feedbacks(
            tenant=self.client_obj, file_content=csv_content, format="csv"
        )
    ...
    def test_import_json(self, mock_webhook):
        ...
        json_content = json.dumps(
            {
                "feedbacks": [
                    {
                        "titulo": "Feedback JSON 1",
                        "tipo": "sugestao",
                        "descricao": "Desc 1",
                    },
                    {
                        "titulo": "Feedback JSON 2",
                        "tipo": "elogio",
                        "descricao": "Desc 2",
                    },
                ]
        ...
        result = ImportService.import_feedbacks(
            tenant=self.client_obj, file_content=json_content, format="json"
        )
    ...
    def test_import_invalid_json(self):
        """Teste JSON inválido."""
        result = ImportService.import_feedbacks(
            tenant=self.client_obj, file_content=b"invalid json", format="json"
        )
    ...
    def test_normalize_status(self):
        ...
        self.assertEqual(
            ImportService._normalize_status("Em Andamento"), "em_andamento"
        )
