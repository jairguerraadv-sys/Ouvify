...
def handle_checkout_completed(data: Dict) -> Dict[str, Any]:
    ...
    logger.info(f"Subscription {'criada' if created else 'atualizada'}: {subscription.id}")
...
def cancel_subscription(subscription: Subscription, at_period_end: bool = True) -> Dict[str, Any]:
    """
