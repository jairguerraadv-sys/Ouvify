...
def test_plan(db):
    ...
    return Plan.objects.create(
        ...
        features={"analytics": True, "automations": True, "webhooks": True},
        limits={"feedbacks_per_month": 1000, "team_members": 5},
...
class TestSubscriptionLifecycle:
    ...
    def test_subscription_trial_start(self, test_plan, create_tenant):
        ...
        subscription = Subscription.objects.create(
            client=tenant, plan=test_plan, status=Subscription.STATUS_TRIALING
        )
    ...
    def test_subscription_past_due_grace_period(self, test_plan, create_tenant):
        ...
        subscription = Subscription.objects.create(
            client=tenant, plan=test_plan, status=Subscription.STATUS_PAST_DUE
        )
    ...
    def test_subscription_unique_per_tenant(self, test_plan, create_tenant):
        ...
        Subscription.objects.create(
            client=tenant, plan=test_plan, status=Subscription.STATUS_ACTIVE
        )
...
class TestCheckoutLogic:
    ...
    def test_checkout_session_creation_mock(
        self, mock_stripe_api, test_plan, create_tenant
    ):
        ...
        session_data = {
            ...
            "line_items": [{"price": test_plan.stripe_price_id, "quantity": 1}],
        }
...
class TestStripeServiceMocked:
    ...
    def test_create_customer_mock(self, mock_stripe_api, test_user, create_tenant):
        ...
        customer_data = {
            ...
            "name": tenant.nome,
            "metadata": {"client_id": str(tenant.id)},
        }
