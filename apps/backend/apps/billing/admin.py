...
class PlanAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Identificação", {"fields": ("name", "slug", "description")}),
        (
            "Preços",
            {
                "fields": (
        ...
        (
            "Features & Limites",
            {"fields": ("features", "limits"), "classes": ("collapse",)},
        ),
        (
            "Configurações",
...
class SubscriptionAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Relacionamentos", {"fields": ("client", "plan")}),
        ("Status", {"fields": ("status", "is_active", "cancel_at_period_end")}),
        (
            "Stripe",
            {
...
class InvoiceAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Relacionamentos", {"fields": ("client", "subscription")}),
        ("Valores", {"fields": ("amount_cents", "amount_display", "currency")}),
        ("Status", {"fields": ("status", "is_paid")}),
        (
            "Stripe",
            {
        ...
        ("Datas", {"fields": ("period_start", "period_end", "paid_at", "due_date")}),
        ("Informações", {"fields": ("description",), "classes": ("collapse",)}),
        (
            "Timestamps",
            {"fields": ("created_at", "updated_at"), "classes": ("collapse",)},
        ),
