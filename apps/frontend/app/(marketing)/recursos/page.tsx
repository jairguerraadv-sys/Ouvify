        ...
        <Container>
          <div className="text-center mb-16">
            ...
            <Paragraph className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Uma plataforma completa com recursos poderosos, fácil de usar e
          ...
          <div className="mb-20">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              {CORE_FEATURES.map((feature, idx) => (
                <Card
                  key={idx}
                  className="border-2 border-border hover:border-primary transition-all duration-300 hover:shadow-xl bg-card"
                >
                  <CardHeader>
                    <div className="flex items-start gap-4 mb-4">
                      ...
                      <div>
                        <CardTitle className="text-xl mb-2 text-secondary">
                          {feature.title}
                        </CardTitle>
              ...
              {ADVANCED_FEATURES.map((feature, idx) => (
                ...
                >
                  <CardHeader>
                    ...
                    <CardTitle className="text-lg mb-2 text-secondary">
                      {feature.title}
                    </CardTitle>
      ...
      <section className="py-20">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <Paragraph className="text-xl text-muted-foreground mb-8">
            Teste todos os recursos gratuitamente por 14 dias. Sem cartão de
            crédito.
          </Paragraph>
