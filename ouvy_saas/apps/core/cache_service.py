...
class CacheService:
    ...
    def set_analytics(self, data: dict, params: Optional[dict] = None, timeout: Optional[int] = None) -> bool:
    ...
    def set_recent_feedbacks(self, data: list, limit: int = 10, timeout: Optional[int] = None) -> bool:
...
def cached(prefix: str, timeout: int = 60 * 15, key_builder: Optional[Callable[..., str]] = None):
    """
...
def invalidate_on_change(model_class, cache_prefix: str):
    ...
    def receiver(sender, instance, **kwargs):
        tenant_id = getattr(instance, 'client_id', None) or getattr(instance, 'tenant_id', None)
