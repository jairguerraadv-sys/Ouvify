...
export default function LandingPage() {
  return (
    <>
      ...
      {/* Hero Section */}
      <section className="relative overflow-hidden bg-gradient-to-br from-white via-neutral-50 to-cyan-50">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6">
              ...
              <p className="text-xl text-neutral-600 leading-relaxed">
                Plataforma SaaS completa para gerenciar denúncias, sugestões e
                feedbacks anônimos com total conformidade LGPD e ISO 27001.
              </p>
      ...
      {/* Features Section */}
      <section id="produto" className="py-20 md:py-32 bg-white">
      ...
      {/* Pricing Section */}
      <section id="planos" className="py-20 md:py-32 bg-neutral-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-secondary mb-4">
